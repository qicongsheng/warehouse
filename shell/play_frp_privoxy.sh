...
docker run -d --name privoxy_frp -e SERVER_ADDR=play.qics.top -e PROXY_NAME=proxy_play_privoxy -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=8118 -e REMOTE_PORT=48118 --net=host ghcr.io/qicongsheng/frp:client
