...
docker run -d --restart=always --name pi_jellyfin -e SERVER_ADDR=play.qics.top -e PROXY_NAME=pi_jellyfin -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=8096 -e REMOTE_PORT=38096 --net=host ghcr.io/qicongsheng/frp:client
docker run -d --restart=always --name pi_ssh_39022 -e SERVER_ADDR=play.qics.top -e PROXY_NAME=pi_ssh_39022 -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=9022 -e REMOTE_PORT=39022 --net=host ghcr.io/qicongsheng/frp:client
