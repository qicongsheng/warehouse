...
docker run -d --restart=always --name=registry -p 8000:8000 -p 8443:8443 -p 8001:8081 -v /data/registry:/nexus-data registry.cn-hangzhou.aliyuncs.com/qics/nexus
docker run -d --restart=always --name=registryui -p 8002:8000 registry.cn-hangzhou.aliyuncs.com/qics/registryui
