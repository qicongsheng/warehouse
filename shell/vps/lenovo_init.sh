...
docker run -d --restart=always --name lenovo_ssh_28022 -e SERVER_ADDR=play.qics.top -e PROXY_NAME=lenovo_ssh_28022 -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=8022 -e REMOTE_PORT=28022 --net=host ghcr.nju.edu.cn/qicongsheng/frp:client
...
docker run -d --restart=always --name lenovo_nexus_8081 -e SERVER_ADDR=play.qics.top -e PROXY_NAME=lenovo_nexus_8081 -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=8081 -e REMOTE_PORT=8081 --net=host ghcr.nju.edu.cn/qicongsheng/frp:client
...
docker run -d --restart=always --name=pickstar -e USER=root -e PASSWD=Star8ks.# -p 8022:22 -p 8082:8082 --privileged=true -v /tmp:/tmp ghcr.nju.edu.cn/qicongsheng/pickstar
docker run -d --restart=always --name=debian -e USER=root -e PASSWD=Star8ks.# -p 9022:22 --privileged=true -v /tmp:/tmp ghcr.nju.edu.cn/qicongsheng/debian
