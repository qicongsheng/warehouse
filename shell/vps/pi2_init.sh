...
docker run -d --restart=always --name proxy_pi_ssh_30089 -e SERVER_ADDR=play.qics.top -e PROXY_NAME=proxy_pi_ssh_30089 -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=10088 -e REMOTE_PORT=30089 --net=host qics/frp:client
docker run -d --restart=always --name proxy_pi_ssh_39023 -e SERVER_ADDR=play.qics.top -e PROXY_NAME=proxy_pi_ssh_39023 -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=9022 -e REMOTE_PORT=39023 --net=host qics/frp:client
