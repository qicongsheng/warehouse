...
docker run -d --restart=always --name=alist -e PUID=0 -e PGID=0 -e UMASK=022 -p 9080:5244 -v /data/alist:/opt/alist/data -v /tmp:/tmp ghcr.nju.edu.cn/qicongsheng/alist:latest
...
docker run -d --restart=always -e USER=root -e PASSWD=Star8ks.# -p 127.0.0.1:3022:22 --privileged=true -v /data:/data ghcr.nju.edu.cn/qicongsheng/backup:tencent
