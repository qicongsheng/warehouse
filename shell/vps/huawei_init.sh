#!/bin/bash
# curl -fsSL "https://www.qics.top/shell/vps/huawei_init.sh" | /bin/bash
...
#修改root密码
echo root:@Best1216789@ | chpasswd
...
#添加防火墙
curl -fsSL http://www.qics.top/shell/ufw/ufw_huawei.sh | /bin/bash
echo "0 */1 * * * curl -fsSL http://www.qics.top/shell/ufw/ufw_huawei.sh | /bin/bash" >> /var/spool/cron/crontabs/root
#屏蔽暴力破解
