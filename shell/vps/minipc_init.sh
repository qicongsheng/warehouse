...
docker run -d --restart=always --name mini_ssh_20088 -e SERVER_ADDR=play.qics.top -e PROXY_NAME=mini_ssh_20088 -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=10088 -e REMOTE_PORT=20088 --net=host ghcr.io/qicongsheng/frp:client
docker run -d --restart=always --name mini_ssh_29022 -e SERVER_ADDR=play.qics.top -e PROXY_NAME=mini_ssh_29022 -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=9022 -e REMOTE_PORT=29022 --net=host ghcr.io/qicongsheng/frp:client
