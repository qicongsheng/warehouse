...
docker run -d --restart=always --name mini_nginx -e SERVER_ADDR=play.qics.top -e PROXY_NAME=mini_nginx -e SERVER_PORT=7000 -e TOKEN=badboy -e LOCAL_PORT=9000 -e REMOTE_PORT=29000 --net=host qics/frp:client
