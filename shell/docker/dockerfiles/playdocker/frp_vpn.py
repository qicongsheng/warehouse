...
def start_docker_container_v2(browser_):
    ...
    try:
        ...
        traceback.print_exc()
    return docker_msg.__contains__('qics/shadowsocks')
...
def init_frp_vpn():
    ...
    try:
        ...
        browser = webdriver.Remote("http://play.qics.top:4444/wd/hub", options=options)
        ...
        browser.find_element(By.XPATH, '/html/body/div[2]/main/section/div/div/div/form/div[2]/button').click()
