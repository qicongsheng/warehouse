...
docker run -d --name qics_dind --privileged=true -v /tmp:/tmp ghcr.io/qicongshengdind
sleep 20
...
docker commit qics_dind ghcr.io/qicongshengdind:tencent
docker push ghcr.io/qicongshengdind:tencent
