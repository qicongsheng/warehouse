...
docker buildx build --build-arg FRP_VERSION=0.55.1 --platform linux/amd64,linux/arm64 -t qics/frp:server_0.55.1 . --push
docker buildx build --build-arg FRP_VERSION=0.55.1 --platform linux/amd64,linux/arm64 -t qics/frp:server . --push
...
docker buildx build --build-arg FRP_VERSION=0.55.1 --platform linux/amd64,linux/arm64 -t qics/frp:client_0.55.1 . --push
