...
docker buildx build -t ghcr.io/qicongsheng/vaultwarden:alpha --platform linux/amd64,linux/arm64 . --push
docker buildx build -t registry.cn-hangzhou.aliyuncs.com/qics/vaultwarden:alpha --platform linux/amd64,linux/arm64 . --push
