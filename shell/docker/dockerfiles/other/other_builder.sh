...
curl -fsSL https://www.qics.top/shell/docker/common/build_cross_platform.sh | /bin/sh -s "nexus"
cd /tmp && rm -fr /tmp/_nexus
...
curl -fsSL https://www.qics.top/shell/docker/common/build_cross_platform.sh | /bin/sh -s "cloudreve"
cd /tmp && rm -fr /tmp/_cloudreve
...
curl -fsSL https://www.qics.top/shell/docker/common/build_cross_platform.sh | /bin/sh -s "pgyvpn"
cd /tmp && rm -fr /tmp/_pgyvpn
...
curl -fsSL https://www.qics.top/shell/docker/common/build_cross_platform.sh | /bin/sh -s "privoxy"
cd /tmp && rm -fr /tmp/_privoxy
...
curl -fsSL https://www.qics.top/shell/docker/common/build_cross_platform.sh | /bin/sh -s "samba"
cd /tmp && rm -fr /tmp/_samba
