#!/bin/bash
# curl -fsSL https://www.qics.top/shell/docker/dockerfiles/common/sync_amd64_platform.sh | /bin/sh
REGISTRY_SOURCE=$1
REGISTRY_TARGET=$2
IMG_NAME=$3
IMG_VERSION=$4
...
docker manifest create $REGISTRY_TARGET/$IMG_NAME:$IMG_VERSION $REGISTRY_TARGET/$IMG_FULL_NAME_PLATFORM_AMD64 --amend
