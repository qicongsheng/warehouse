...
curl -fsSL https://www.qics.top/shell/docker/common/sync_amd64_platform.sh | /bin/sh -s "ghcr.io/qicongsheng" "registry.cn-hangzhou.aliyuncs.com/qics" $IMG_NAME $IMG_VERSION
