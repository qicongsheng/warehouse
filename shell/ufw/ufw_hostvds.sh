...
deny_ports=(19986 29986 39986 49986 59986 22 1022 2022 3022 4022 5022 6022 7022 8022 9022)
/usr/sbin/ufw deny $(IFS=',' ; echo "${deny_ports[*]}")/tcp

deny_ports=(10088 11022 12022 13022 14022 15022 16022 17022 18022 19022)
/usr/sbin/ufw deny $(IFS=',' ; echo "${deny_ports[*]}")/tcp

deny_ports=(20088 21022 22022 23022 24022 25022 26022 27022 28022 29022)
/usr/sbin/ufw deny $(IFS=',' ; echo "${deny_ports[*]}")/tcp

deny_ports=(30088 31022 32022 33022 34022 35022 36022 37022 38022 39022)
/usr/sbin/ufw deny $(IFS=',' ; echo "${deny_ports[*]}")/tcp

deny_ports=(40088 41022 42022 43022 44022 45022 46022 47022 48022 49022)
/usr/sbin/ufw deny $(IFS=',' ; echo "${deny_ports[*]}")/tcp

deny_ports=(50088 51022 52022 53022 54022 55022 56022 57022 58022 59022 )
/usr/sbin/ufw deny $(IFS=',' ; echo "${deny_ports[*]}")/tcp
