...
curl --connect-timeout 600 -m 7200 --continue-at - -o /tmp/python-3.9.12-debian.tar.gz https://ehckxq.sn.files.1drv.com/y4msFMU-V_ZIaEEvZiVvir06mZSmkmvvhHs-HkhmS5H21UgJsROtFyn32ycnmgE8iEqiv8uSqsyNyyT-KeKlcc7m7zcwy6TcuUj-U3_0HLWHnbuB-2PNeHUR6G3BpCssi9DhqrFrhP-Mr3ia5P6CeTeGsWj7ZLPimHcd3A59EOfuazyM5TadnnHocAeQSL38Oe90K1ug7JxftKsUULfVuMBjg
echo "sleep 5s start"
sleep 5
echo "sleep 5s end"
